...
for root, dirs, files in os.walk(directory):
    ...
    for file in files:
        ...
        if file.endswith(".pkl"):
            ...
            fold_wt_pura_model_0_df = get_df('fold_pura_wt_wt_model_0_array')
            ...
            # dict = {
            #     'resi': mutant_df['resi'].tolist(),
            #     'atom': mutant_df['atom'].tolist(),
            #     '_8chw_comparison': _8chw_comparison.tolist(),
            #     '_8cht_comparison': _8cht_comparison.tolist(),
            #     'fold_wt_pura_model_0_comparison': fold_wt_pura_model_0_comparison.tolist()
            # }
            ...
            # json_name = os.path.join(os.path.dirname(file_path),f'{name}.json')
